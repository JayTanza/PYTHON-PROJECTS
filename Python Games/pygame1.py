...
def buttonpress1(b1):
    b1["text"] = "A"
    if (b2["text"] == "N" and b3["text"] == "T") or (b4["text"] == "C" and b7["text"] == "H") or (
            b5["text"] == "A" and b9["text"] == "W"):
...
def buttonpress3(b3):
    b3["text"] = "T"
    if (b2["text"] == "N" and b1["text"] == "A") or (b6["text"] == "N" and b9["text"] == "W") or (
            b5["text"] == "A" and b7["text"] == "H"):
        messagebox.showinfo("Warning", "Your chances over ,check result")
...
def buttonpress7(b7):
    b7["text"] = "H"
    if (b1["text"] == "A" and b4["text"] == "C") or (b8["text"] == "O" and b9["text"] == "W") or (
            b5["text"] == "A" and b3["text"] == "T"):
        messagebox.showinfo("Warning", "Your chances over ,check result")
...
def buttonpress9(b9):
    b9["text"] = "W"
    if (b6["text"] == "N" and b3["text"] == "T") or (b8["text"] == "O" and b7["text"] == "H") or (
            b5["text"] == "A" and b1["text"] == "A"):
        messagebox.showinfo("Warning", "Your chances over ,check result")
...
b10 = Button(gui, text="Credits", width=10, height=5, bg="yellow", fg="black", font="Verdana 10 bold",
             command=lambda: credits1(b10))
b10.grid(row=3, column=0)
b12 = Button(gui, text="Reset", width=10, height=5, bg="blue", fg="white", font="Verdana 10 bold",
             command=lambda: reset(b12))
b12.grid(row=3, column=2)
b11 = Button(gui, text="Result", width=10, height=5, bg="green", fg="white", font="Verdana 10 bold",
             command=lambda: Showresult(b11))
b11.grid(row=0, column=3)
b13 = Button(gui, text="Quit", width=10, height=5, bg="red", fg="white", font="Verdana 10 bold",
             command=lambda: play(b13))
...
L1 = Label(gui, text="Just 3 Words", width=10, height=5, fg="white", bg="orange", font="Verdana 10 bold").grid(row=3,
                                                                                                               column=3)
L1 = Label(gui, text="Guess it", width=10, height=5, fg="black", bg="white", font="Verdana 10 bold").grid(row=2,
                                                                                                          column=3)
